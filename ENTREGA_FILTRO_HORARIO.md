...
**Funcionalidades:**
- **Verificação de Horário:** No início de cada candle, o bot verifica se o horário atual (UTC) está na lista de horários permitidos
...
**Interface Visual:**
- **Grade de 24 Horários:** Todos os horários de 0h a 23h UTC exibidos em uma grade 6x4
...
[HOURLY_FILTER] Horários permitidos: 12h, 16h, 18h, 20h
[HOURLY_FILTER] Horários GOLD: 16h, 18h (2x stake)
```

Quando o bot estiver aguardando um horário permitido:

```
[HOURLY_FILTER_BLOCKED] Horário 15h UTC não permitido. Aguardando próximo horário: 16h UTC
```
